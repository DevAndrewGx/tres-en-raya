 ...
 * @author Andrey
 */
public class FormBegin extends javax.swing.JFrame {

    /**
     * Creates new form FormBegin
     */
    public FormBegin() {
        init();
    }
    ...
    private void initComponents() {
        ...
        panelBackground.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                panelBackgroundMousePressed(evt);
            }
        });
        ...
        panelBackground.add(txtJugador2);
        ...
        panelBackground.add(txtJugador1);
        ...
        lblInicio.setForeground(new java.awt.Color(241, 227, 252));
        lblInicio.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblInicio.setText("INICIAR");
    ...
    private void panelBackgroundMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelBackgroundMousePressed
        panelBackground.requestFocus();
    }//GEN-LAST:event_panelBackgroundMousePressed
    ...
    private controller.Imagen imagen4;
